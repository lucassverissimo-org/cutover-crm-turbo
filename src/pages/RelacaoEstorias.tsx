...
export default function RelacaoEstorias() {
  ...
  const editarEstoria = (registro: any) => {
    setDadosEdicao(registro)
  }

  const deletarEstoria = async (registro: any) => {
  ...
  return (
    <div className="space-y-10">
      <div className="bg-white dark:bg-gray-800 shadow-md rounded-xl p-6">
        ...
        <FormularioGenerico campos={campos} onSalvar={salvarEstoria} dadosEdicao={dadosEdicao} />
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 shadow-md rounded-xl p-6">
        ...
        <TabelaGenerica
          ...
          colunas={colunas}
          ref={refTabela}
          onEditar={editarEstoria}
          onDeletar={deletarEstoria}
        />
      </div>
    </div>
  )
